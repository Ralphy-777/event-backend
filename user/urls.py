...
urlpatterns = [
    ...
    path('bookings/extensions/', views.get_booking_extensions, name='get_booking_extensions'),
    path('bookings/<int:booking_id>/request-extension/', views.request_booking_extension, name='request_booking_extension'),
    path('bookings/<int:booking_id>/handle-extension/', views.handle_booking_extension, name='handle_booking_extension'),
