...
urlpatterns = [
    ...
    path('bookings/<int:booking_id>/handle-extension/', views.handle_extension, name='handle_extension'),
    path('bookings/extensions/', views.get_extension_requests, name='get_extension_requests'),
